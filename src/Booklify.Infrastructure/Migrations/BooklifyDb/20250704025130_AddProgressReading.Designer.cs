...
namespace Booklify.Infrastructure.Migrations.BooklifyDb
{
    ...
    [Migration("20250704025130_AddProgressReading")]
    partial class AddProgressReading
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Booklify.Domain.Entities.ReadingProgress", b =>
                {
                    ...
                    b.Property<double>("CfiProgressPercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("float(5)");

                    b.Property<double>("ChapterCompletionPercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("float(5)");
                    ...
                    b.HasIndex("BookId", "LastReadAt");

                    b.HasIndex("BookId", "OverallProgressPercentage");

                    b.HasIndex("UserId", "BookId");

                    b.HasIndex("UserId", "LastReadAt");

                    b.HasIndex("UserId", "OverallProgressPercentage");
